...
# 53 "C:\Program Files\Microchip\xc8\v2.36\pic\include\proc\pic18f44k22.h"
...
# 23 "../sht85.h"
typedef enum {
CMD_READ_SHT4X_SERIAL_NUMBER = 0x0089,
CMD_SHT4X_MEASURE_TRH_HI_HIGH_PREC = 0x00FD,
...
typedef enum {
SINGLE_MEAS_LOW = CMD_MEAS_SINGLE_L,
SINGLE_MEAS_MEDIUM = CMD_MEAS_SINGLE_M,
SINGLE_MEAS_HIGH = CMD_MEAS_SINGLE_H
...
unsigned char I2C_WRITEdata[32], I2C_READdata[32] = "START READ";
...
float arrThermistorResistance[11] = {32624.0, 25381.0, 19897.0, 15711.0, 12493.0, 10000.0, 8056.0, 6529.7, 5323.9, 4365.3, 3598.7};
...
# 80
TableType arrRHCalTable[64];

void main()
{

# 97
unsigned char OutBytes[32], InBytes[32];
int length = 0;
...
# 138
sprintf(OutBytes, "#%d: 01234567890", trial++);
length = 16;
LATDbits.LATD2 = 1;
errorFlag = i2c_SlaveWrite(0x27, length, OutBytes);
LATDbits.LATD2 = 0;
if (errorFlag) printf("\r#%d: SEND, ERRORS: %d", trial, errorFlag);
for (i = 0; i < 32; i++) InBytes[i] = OutBytes[i] = 0;
errorFlag = i2c_SlaveRead(0x27, length, InBytes);
...
if (PIC_EEprom_read(address)==data)
return 1;
else
return 0;
}
...
TRISBbits.RB5 = 1;
TRISBbits.RB3 = 0; PORTBbits.RB3 = 0;
}
...
TRISBbits.RB3 = 1;
TRISBbits.RB5 = 0; PORTBbits.RB5 = 0;
}
...
TRISBbits.RB3 = 1;
TRISBbits.RB4 = 0; PORTBbits.RB4 = 0;
}
...
CalADCounts = ADRES;
CTMUCONLbits.EDG1STAT = 0;
CalADSum += CalADCounts;
}

CalADaverage = (float)(CalADSum / 10.000);
CalVoltage = (float)((CalADaverage / 1023) * 3.3) + 0;
CalCurrent = CalVoltage / 3.6;
...
CapADCounts = ADRES;
CapADSum += CapADCounts;
}

CapADaverage = (float)(CapADSum / 10.000);
CapVoltage = (float)((CapADaverage / 1023) * 3.3) + 0;

if (CapVoltage == 0) return 0;


CapMeasured = (CalCurrent * 750) / CapVoltage;
...
ThermistorCounts = (unsigned short) ADRES;
